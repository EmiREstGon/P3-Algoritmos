...
std::ostream& operator<<(std::ostream& os, const Polynomial& p) { // salida de texto en consola (http://www.cplusplus.com/reference/ostream/ostream/)
  p.Write(os);
  return os;
}
...
std::ostream& operator<<(std::ostream& os, const SparsePolynomial& p) { // salida de texto en consola (http://www.cplusplus.com/reference/ostream/ostream/)
  p.Write(os);
  return os;
}
